/* scroll-conductor.js
   From Meng To's agent-skills repository (github.com/MengTo/skills),
   build-threejs-scroll-worlds/references/scroll-conductor.js — MIT licensed,
   Copyright (c) 2026 Meng To. Vendored unmodified.

   The MIT terms are reproduced in scroll-conductor.LICENSE alongside this file.

   NOTE ON PROVENANCE: this file comes from the SKILLS repo, which is MIT.
   The Kage project itself (github.com/MengTo/kage) grants NO reuse rights,
   so none of its scene code or artwork is used anywhere in this project —
   only the published technique and this explicitly-MIT conductor.
*/
